...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
      ...
      return {
        a: common_vendor.f($data.fieldsMap, (mapper, index, i1) => {
          return common_vendor.e({
            ...
            c: common_vendor.o(($event) => $options.inputDialogToggle(item.path, item.title)),
            d: "0825922a-13-" + i0 + "-" + i1 + "," + ("0825922a-12-" + i0 + "-" + i1),
            e: common_vendor.p({
              type: "compose",
              color: "#2979ff",
              size: "25"
            ...
            f: mapper.field,
            g: "0825922a-12-" + i0 + "-" + i1 + "," + ("0825922a-11-" + i0)
          } : {
            h: common_vendor.t(item[mapper.field] !== void 0 ? item[mapper.field] : "-"),
            i: mapper.field,
            j: "0825922a-14-" + i0 + "-" + i1 + "," + ("0825922a-11-" + i0),
            k: common_vendor.p({
    ...
    y: common_vendor.sr("inputClose", "0825922a-17,0825922a-16"),
    z: common_vendor.o($options.editName),
    A: common_vendor.o(($event) => $data.updateValue = $event),
    B: common_vendor.p({
      mode: "input",
      title: "\u8BF7\u7F16\u8F91\u540D\u79F0",
      placeholder: "\u8BF7\u8F93\u5165\u5185\u5BB9",
    ...
    C: common_vendor.sr("inputDialog", "0825922a-16"),
    D: common_vendor.p({
      type: "dialog",
      maskClick: true
    })
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "C:/Users/yzc/Documents/HBuilderProjects/uni-admin \u57FA\u7840\u6846\u67B6/pages/uni-stat/page-res/page-res.vue"]]);
